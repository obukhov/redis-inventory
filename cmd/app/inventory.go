...
var scanCmd = &cobra.Command{
	...
	Long:  "Scan command builds prefix tree in memory and then displays usage summary. To play with different ways of display without reindexing redis instance every time, use `index` and `display` commands",
